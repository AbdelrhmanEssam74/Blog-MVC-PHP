    ...
    <div class="row mb-2 mt-4">
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                ...
                <div class="col-lg-5 col-12 d-lg-block">
                    <img src="assets/images/image4.jpg" class="bd-placeholder w-100" width="200" height="250"
        ...
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                ...
                <div class="col-lg-5 col-12 d-lg-block">
                    <img src="assets/images/image3.jpg" class="bd-placeholder w-100" width="200" height="250"
                         style="object-fit: cover">
                </div>
            </div>
        </div>
